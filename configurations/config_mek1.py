...
file_names = '../data/raw_data/Q02750/*.mzml'
...
modfication_file_name = '../data/modifications//modifications_Q02750.csv'

# Fasta file for protein of interest
fasta_file_name = '../data/fasta_files/Q02750.fasta'
...
mass_start_range = 43270.0
mass_end_range = 43610.0
