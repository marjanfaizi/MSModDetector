...
class GaussianModel(object): 
    ...
    A window of variable size is slided over the mass spectrum (whitin the selected mass range) with a step size of 1.
    And a gaussian distribution is fitted to the data within that window. 
    The standard deviation is fix and only mean value and amplitude are fitted to the data.
    ...
    The dataframe fitting_results stores for every mean:
            ...
            - the corresponding chi-squared score and pvalue
